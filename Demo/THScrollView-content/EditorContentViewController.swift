...
class EditorContentViewController: UIViewController {
    ...
    @objc func editorDone() {
        ...
        let markerDict:[String: Any] = ["xFloat":positionX,
                                        "yFloat":positionY,
                                        "zoomScale":zoom,
                                        ...
                                        "videoURL":videoPath,
                                        "audioURL":audioPath,
                                        "title":editorScrollView.titleText.text ?? "",
                                        "link":editorScrollView.linkText.text ?? "",
                                        "text":editorScrollView.detailText.text ?? "",
                                        "isText" : isText]
...
extension EditorContentViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        if let imagePickerControllerMediaURL = info["UIImagePickerControllerMediaURL"] as? NSURL {
            videoPath = imagePickerControllerMediaURL
        }
